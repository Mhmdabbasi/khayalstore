...
<div class="first" style="display: block; height:auto !important;background-color: #E6E6E6">
    <table class="content-position" dir="rtl">
        <tr>
    ...
    <table class="bs-0">
        <tr>
            <th class="bg-primary content-position-y" style="padding-right: 0; height: 44px; text-align: left">
                <div>
                    <span class="h4 inline text-white text-uppercase">{{\App\CPU\translate('رقم الطلب والفاتورة :')}} # </span>
                    <span class="inline">
                        <span class="h4 text-white" style="display: inline">{{ $order->id }}</span>
                    </span>
                </div>
            </th>
            <th class="bg-secondary content-position-y" style="text-align: left; height: 44px;">
...
<div class="row" dir="rtl">
    <section>
        <table class="content-position-y" style="width: 100%" dir="rtl">
            <tr>
...
<div class="row" style="margin: 20px 0; display:block; height:auto !important ;" dir="rtl">
    <div class=" content-height content-position-x" style="">
