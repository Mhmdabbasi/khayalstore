        ...
        @else
            <div class="mt-2">
                <form class="needs-validation" action="javascript:" method="post" novalidate id="coupon-code-ajax">
                    ...
                    <button class="btnapplay btn-block" type="button" onclick="couponCode()"style="background:#FF5733; color:white;">{{\App\CPU\translate('apply_code')}}
                    </button>
                </form>
            </div>
            @php($coupon_dis=0)
