...
<style>
    ...
    .product-single-hover .btn:hover{
        font-size: 13px;
        font-weight: bold;
        background: white;
...
<div class="product-single-hover" >
    <div class="inline_product clickable d-flex justify-content-center"
        ...
        @if($product->discount > 0)
            <div class="d-flex" style="
              ...
              position: absolute; 
              ">
                    <span class="for-discoutn-value p-1 pl-2 pr-2" style="background:#FF5555 !important;">
    ...
    <div class="text-center quick-view">
        @if(Request::is('product/*'))
            <a class="btn btn-sm" href="{{route('product',$product->slug)}}">
        ...
        @else
            ...
            <a class="btn btn-sm" href="javascript:"
               onclick="quickView('{{$product->id}}')">
                ...
                {{\App\CPU\translate('مشاهدة سريعة')}}   {{\App\CPU\translate('')}}
            </a>
        @endif
    </div>
</div>
