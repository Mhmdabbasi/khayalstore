        ...
        <div class="row">
            <div class="col-md-12 mb-5 pt-5">
                <div class="feature_header">
                    <span>{{ \App\CPU\translate('معلومات العناوين والشحن')}}</span>
                </div>
            </div>
                                        ...
                                        <div id="accordion">
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleInputPassword1">{{ \App\CPU\translate('نوع العنوان')}}</label>
                                                        <select class="form-control" name="address_type">
                                                            <option
                                                                value="permanent">{{ \App\CPU\translate('عنوان دائم')}}</option>
                                                            <option value="home">{{ \App\CPU\translate('المنزل')}}</option>
                                                            <option
                                                                value="others">{{ \App\CPU\translate('أخرى')}}</option>
                                                        </select>
                                                    </div>
...
{{--                                        {{$billing_addresses->count()==0?'checked':''}}--}}
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a class="btnback btn-block" href="{{route('shop-cart')}}">
                        ...
                        <div class="col-6">
                            <a class="btnpay btn-block" href="javascript:" onclick="proceed_to_next()">
