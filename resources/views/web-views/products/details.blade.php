                        ...
                        <div class="details">
                            ...
                            <!-- Quantity + Add to cart -->
                                ...
                                <div class="d-flex justify-content-start mt-2 mb-3">
                                    <button
                                        class="btnbuy2 element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"
                                        onclick="buy_now()"
                                        type="button">
                                        <span class="string-limit">{{\App\CPU\translate('buy_now')}}</span>
                                    </button>
                                    <button
                                        class="btnadd element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"
                                        onclick="addToCart()"
                                        type="button"
                                        style="width:37%; height: 45px;{{Session::get('direction') === "rtl" ? 'margin-right: 20px;' : 'margin-left: 20px;'}}">
                                        <span class="string-limit">{{\App\CPU\translate('إضافة للسلة')}}</span>
                                    </button>
