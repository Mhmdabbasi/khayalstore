    ...
    <div class="container pb-5 mb-2 mb-md-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <!-- <div class="row">
                    <div class="col-6">
                        <a class="btnback" href="{{route('shop-cart')}}">
                            <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} mt-sm-0 mx-1"></i>
                           {{\App\CPU\translate('Back')}} {{\App\CPU\translate('to')}}  {{\App\CPU\translate('Cart')}} 
                        </a>
                    </div>
                    <div class="col-6">
                        @if(auth('customer')->check())
                            <a class="btnpay" href="{{route('shop-cart')}}">
                                {{\App\CPU\translate('shop_cart')}}{{\App\CPU\translate('Next')}}
