                    ...
                    <div class="row flex-between align-items-center g-2 mb-3">
                        <div class="col-sm-6">
                            <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                <img src="{{asset('/public/assets/back-end/img/business_analytics.png')}}" alt="">{{\App\CPU\translate('تحليلات نشاط العمل')}}</h4>
                        </div>
                            ...
                            <div class="row g-2 align-items-center">
                                <div class="col-md-6">
                                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                        ...
                                        {{\App\CPU\translate('إحصائيات المكاسب')}}
                                    </h4>
                                </div>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="yearEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\translate('هذا العام')}}</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="MonthEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\translate('هذا الشهر')}}</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="WeekEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\translate('هذا الأسبوع')}}</span>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
