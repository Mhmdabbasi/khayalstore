...
<div class="col-sm-6 col-lg-3">
    <!-- Business Analytics Card -->
    <div class="business-analytics">
        <h5 class="business-analytics__subtitle">{{\App\CPU\translate('إجمالي المتاجر')}}</h5>
...
<div class="col-sm-6 col-lg-3">
    <!-- Business Analytics Card -->
    <div class="business-analytics">
        <h5 class="business-analytics__subtitle">{{\App\CPU\translate('إجمالي المنتجات')}}</h5>
...
<div class="col-sm-6 col-lg-3">
    <!-- Business Analytics Card -->
    <div class="business-analytics">
        <h5 class="business-analytics__subtitle">{{\App\CPU\translate('إجمالي العملاء (الزبائن)')}}</h5>
...
<div class="col-sm-6 col-lg-3">
    <div class="order-stats order-stats_failed cursor-pointer" onclick="location.href='{{route('admin.orders.list',['failed'])}}'">
        <div class="order-stats__content" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            ...
            <h6 class="order-stats__subtitle">{{\App\CPU\translate('طلبات لم تصل (مشكلة في التوصيل أو التسليم)')}}</h6>
        </div>
