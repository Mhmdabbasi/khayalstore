    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
            <h2 class="h1 mb-0 d-flex gap-2">
                ...
                {{\App\CPU\translate('')}} {{\App\CPU\translate('إضافة منتج جديد')}} {{\App\CPU\translate(':')}}
            </h2>
        </div>
        <!-- End Page Title -->
                                ...
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{ $lang == $default_lang ? 'required' : '' }} name="name[]"
                                            id="{{ $lang }}_name" class="form-control" placeholder="اسم المنتج (*ملاحظة* : قم باضافة اسم واضح للمنتج)">
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="js-example-basic-multiple form-control" name="category_id"
                                    ...
                                    required>
                                    <option value="{{ old('category_id') }}" selected disabled>---اختر االصنف الذي ينتمي له المنتج---
                                    </option>
                                    @foreach ($cat as $c)
                                        <option value="{{ $c['id'] }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <select
                                    ...
                                    <option value="{{ null }}" selected disabled>
                                        ---{{ \App\CPU\translate('اختر العلامة التجارية للمنتج') }}---</option>
                                    @foreach ($br as $b)
