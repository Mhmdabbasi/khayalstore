                            ...
                            <div class="row gy-3 gx-2">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <select name="filter" class="form-control">
                                        <option value="all" {{ $filter == 'all' ? 'selected' : '' }}>كل الطلبات</option>
                                        <option value="admin" {{ $filter == 'admin' ? 'selected' : '' }}>طلبات المتجر الداخلي</option>
                                        <option value="seller" {{ $filter == 'seller' ? 'selected' : '' }}>البائعين</option>
                                        @if($status == 'all' || $status == 'delivered')
                                        <option value="POS" {{ $filter == 'POS' ? 'selected' : '' }}>نقطة البيع الرئيسية</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                ...
                                <tr class="status-{{$order['order_status']}} class-all">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            @else
                                                <label class="badge badge-danger fz-12">{{\App\CPU\translate('قامت الإدارة أو العميل بحذف الحساب')}}</label>
                                            @endif
                                        @endif
                                    </td>
                                    <td>
